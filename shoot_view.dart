...
class _ShootViewState extends State<ShootView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Create a Tween for the Y-offset movement (negative = up, positive = down)
